void plotRadonCountAtTwoLocationsVsH2OContent()
{
    
    // count radon in surrounding grain
    ...
    // same operation again but count radon in pore space
    ...
    for(int i=0;i<=21;i++)
    {
        eCounts2[i] = (eCounts2[i]/10000)*100;
    }
